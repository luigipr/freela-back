...
import { deleteSessions, findUserByEmail, postUser } from "../repositories/auth.repositories.js"
...
export async function signup(req, res) {
    ...
    const {name, lastName, email, location, password, confirmPassword} = req.body
    ...
    try {
        ...
        await postUser(name, lastName, email, location, hash)
